...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_02b21e651b88e75cb99f25c728b3f204df9cedbf": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){Module.exports.sumArray = ($1)})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.rust_stdweb.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "rust-stdweb.wasm" );
        ...
        const __promise = fetch( "rust-stdweb.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'rust_stdweb'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'rust_stdweb':", error );
                throw error;
            });

        Rust.rust_stdweb = __promise;
        return __promise;
    }
}));
