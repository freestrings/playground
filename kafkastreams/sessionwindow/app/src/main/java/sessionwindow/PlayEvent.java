...
public class PlayEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PlayEvent\",\"namespace\":\"sessionwindow\",\"fields\":[{\"name\":\"song_id\",\"type\":\"long\"},{\"name\":\"duration\",\"type\":\"long\"}]}");
   ...
   */
  public PlayEvent(Long song_id, Long duration) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: song_id = (Long)value$; break;
   ...
   * @return A new PlayEvent RecordBuilder
   */
  public static PlayEvent.Builder newBuilder(PlayEvent.Builder other) {
    if (other == null) {
      return new PlayEvent.Builder();
    } else {
      return new PlayEvent.Builder(other);
    }
  }
   ...
   * @return A new PlayEvent RecordBuilder
   */
  public static PlayEvent.Builder newBuilder(PlayEvent other) {
    if (other == null) {
      return new PlayEvent.Builder();
    } else {
      return new PlayEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PlayEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PlayEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PlayEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.song_id)) {
        this.song_id = data().deepCopy(fields()[0].schema(), other.song_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public PlayEvent.Builder setSongId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlayEvent.Builder clearSongId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlayEvent.Builder setDuration(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlayEvent.Builder clearDuration() {
    ...
    public PlayEvent build() {
      try {
        ...
        record.song_id = fieldSetFlags()[0] ? this.song_id : (Long) defaultValue(fields()[0]);
